...
// const CommentEditModal = ({ showCommentEditModal, singleVehicle }) => {
//   // console.log(typeof singleVehicle.vid);
...
//     e.preventDefault();
//     if (comment !== "" && rating !== 0) {
//       dispatch(__putVehicleComments({ comment, rating, vid }));
//       setComment("");
//       setRating(0);
...
//       <AiOutlineClose className="icon" onClick={showCommentEditModal} />
...
//             <button className="reviewButton" onClick={onPutHandler}>
//               수정
//             </button>
